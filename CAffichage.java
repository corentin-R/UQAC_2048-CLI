...
class CAffichage {
	...
	*/
	...
	/**
	*fonction permettant de transformer la matrice int[][]
	*de base en une matrice de char[][] plus jolie à afficher
	...
	*/
	...
	/**
	*remplit les ligne appropriées (hauteurMatrice%hauteurCase)
	*avec des char '-'
	*/
	...
	/**
	*remplit les colonnes appropriées (largeurMatrice%largeurCase)
	*avec des char '|'
	*/
	...
	/**
	*remplit la matrice de char avec des ' ' puis
	*met en place les séparateurs de lignes et de colonnes
	*/
	...
	*/
	...
	/**
	*met les chiifres de la matrice de 
	*base dans la matrice de char qui sera affichee
	...
	*/
	...
	/**
	*décompose un nombre en chiffre par unité, dizaine,
	* centaine et millier et les place au bons endroits
	*transformation d'un int en plusieur char avce la table ASCII (+48)
